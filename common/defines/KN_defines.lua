-- Krasnacht defines values

NDefines.NGame.START_DATE = "1950.1.1.1"									-- Vanilla 1936.1.1.1
NDefines.NGame.END_DATE = "1975.1.1.1"										-- Vanilla 1949.1.1.1
...
NDefines.NGame.MESSAGE_TIMEOUT_DAYS = 60
NDefines.NGame.AIR_LOG_TIMEOUT_HOURS = 24
NDefines.NGame.EVENT_TIMEOUT_DEFAULT = 13
NDefines.NGame.MISSION_REMOVE_FROM_INTERFACE_DEFAULT = 13
NDefines.NGame.DECISION_ALERT_TIMEOUT_DAYS = 60
NDefines.NGame.NAVAL_COMBAT_CONVOY_SIZE = 0.20
NDefines.NGame.FUEL_RESOURCE = "oil"
NDefines.NGame.MAX_EFFECT_ITERATION = 100							-- Vanilla is 30
...
NDefines.NWiki.BASE_URL = "http://wikipedia.com"
